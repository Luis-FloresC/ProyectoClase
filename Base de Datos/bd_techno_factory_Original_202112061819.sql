...
-- Script date 6/12/2021 18:19:46
...
--
-- Drop procedure `ListarProductos2`
--
DROP PROCEDURE IF EXISTS ListarProductos2;
...
--
CREATE PROCEDURE AccionesEmpleados(IN id int, IN Accion varchar(50), IN txtDni varchar(50), IN nombre varchar(50), IN apellido varchar(50), IN gen varchar(50), IN fechaNac date, IN estado int)
BEGIN
...
DECLARE acciones varchar(1000);

set acciones = '<form action="/Clientes/CargarDatos/#" method="get">
    <button class="btn btn-warning" ><i class="zmdi zmdi-edit"></i></button>
</form>
<form action="/Clientes/EliminarDatos/#" method="get">
...
SELECT
  c.idCliente AS num,
  c.dni,
  CONCAT(c.nombreCliente, ' ', c.apellidoCliente) 'nombre',
  TIMESTAMPDIFF(year, c.fechaNacimiento, CURDATE()) AS edad,
  c.genero,
  e.estado,
  IF(e.idEstado = 1, '<button type="button" class="btn btn-success">Activo</button>', '<button type="button" class="btn btn-danger">Inactivo</button>') AS isActivo,
  REPLACE(acciones, '#', c.idCliente) acciones
...
--
CREATE PROCEDURE AccionesClientes(IN id int, IN Accion varchar(50), IN txtDni varchar(50), IN nombre varchar(50), IN apellido varchar(50), IN gen varchar(50), IN fechaNac date, IN estado int)
BEGIN
...
--
CREATE PROCEDURE CategoriasYMas(IN accion varchar(2), IN tabla varchar(2), IN codMarca int, IN marca varchar(50), IN codModelo int, IN modelo varchar(255), IN codCategoria int, IN categoria varchar(255), IN estado int)
BEGIN
...
--
-- Create procedure `ListarProductos2`
--
CREATE PROCEDURE ListarProductos2()
BEGIN
  DECLARE i int;
  DECLARE acciones varchar(1000);
  set acciones = '<form action="/Productos/CargarDatos/#" method="get">
    <button class="btn btn-warning" ><i class="zmdi zmdi-edit"></i></button>
</form>
<form action="/Productos/EliminarDatos/#" method="get">
    <button class="btn btn-danger" ><i class="zmdi zmdi-delete"></i></button>
</form>';
  SET @row_number = 0;
SELECT
  ...
  e.estado,
  IF(e.idEstado = 1, '<button type="button" class="btn btn-success">Activo</button>', '<button type="button" class="btn btn-danger">Inactivo</button>') AS isActivo,
  REPLACE(acciones, '#', p.idProducto) acciones
FROM Productos p
  JOIN Modelos m
...
--
CREATE PROCEDURE AccionesProductos(IN accion varchar(50), IN id int, IN nombre varchar(50), IN descripcion varchar(2000), IN cantidad int, IN categoria int, IN estado int, IN estandar decimal(10, 2), IN venta decimal(10, 2), IN modelo int)
BEGIN
...
--
CREATE PROCEDURE Factura(IN noFactura int)
BEGIN
SELECT
  d.idVenta 'nofactura',
...
--
CREATE PROCEDURE RegistrarUsuarios(IN nombreUser varchar(50), IN contra varchar(50), IN cargo int, IN correo varchar(100), IN codEmpleado int)
BEGIN
...
--
CREATE PROCEDURE EditarUsuario(IN id int, IN nombreUser varchar(50), IN contra varchar(50), IN cargo int, IN correo varchar(100), IN codEmpleado int)
BEGIN
UPDATE Usuarios
...
(7, 'Computadoras de mano (Palmtop Computers)', 2, 0),
...
(8, '0801200003793', 'Luis Adolfo', 'Flores Cstellanos', 'Masculino', '2000-11-10', '2021-11-08 15:27:22', 1);

-- 
-- Dumping data for table clientes
--
INSERT INTO clientes VALUES
(1, '0703200003793', 'Cliente', 'Anonimos', 'Masculino', '2000-08-03', '2021-10-19 01:14:23', 1, 1),
(2, '098976647564', 'Ana', 'Moncada', 'Femenino', '1979-05-17', '2021-10-28 21:36:30', 1, 1),
(3, '0801568943234', 'Alan', 'Mejia', 'Masculino', '2001-04-22', '2021-11-03 09:41:35', 1, 1),
(4, '13456677885', 'Ignacio N', 'Mejia', 'Masculino', '2001-04-22', '2021-11-05 17:55:01', 1, 1),
(5, '0703200003965', 'Gerson', 'Martinez', 'Masculino', '2000-11-02', '2021-11-07 01:15:41', 1, 1),
(6, '1', 'Cliente General 2', 'Ventas', 'Masculino', '2000-11-03', '2021-11-07 21:48:25', 2, 0),
(7, '0705200003793', 'Cliente', 'Anonimos', 'Masculino', '2000-08-03', '2021-11-23 21:26:23', 1, 1),
(8, '0705', 'Cliente 2 Node', 'Anonimos', 'Masculino', '2000-08-03', '2021-11-23 21:32:42', 1, 1),
(9, '06', 'Carlos Ardon', 'Anonimos', 'Masculino', '2000-08-03', '2021-11-23 21:33:02', 1, 1),
(10, '45556', 'Luis Adolfo', 'Flores', 'Masculino', '2021-11-01', '2021-11-26 23:36:59', 1, 1),
(11, '0704195800045', 'Petrona', 'Moncada', 'Femenino', '1959-11-26', '2021-11-26 23:40:55', 1, 1),
(12, '0803200003766', 'Luis Adolfo', 'Flores', 'Masculino', '2000-05-07', '2021-11-27 18:54:05', 1, 1),
(13, '0703195900506', 'Petro ', 'Moncada Diaz', 'Femenino', '1956-11-26', '2021-11-29 21:47:44', 2, 1),
(14, '9080543333333', 'Luis Adolfo', 'Flores', 'Masculino', '2021-12-12', '2021-12-06 02:00:56', 2, 1),
(15, '9080543333333', 'Luis Adolfo', 'Flores', 'Masculino', '2000-12-12', '2021-12-06 02:00:57', 2, 1),
(16, '0356788777777', 'Luis Adolfo', 'Flores Castellanos', 'Masculino', '2002-01-04', '2021-12-06 02:04:05', 1, 1);
...
(84, '2021-11-07 20:57:54', 1, 1, 15.00, 0.00, 35000.00),
(85, '2021-11-08 09:15:33', 1, 1, 15.00, 0.00, 403995.00),
(86, '2021-11-08 09:16:38', 6, 1, 15.00, 0.00, 43995.00),
(87, '2021-11-08 14:36:09', 6, 1, 15.00, 0.00, 70000.00),
(88, '2021-11-08 15:16:55', 1, 1, 15.00, 0.00, 75995.00),
(89, '2021-11-25 13:55:55', 1, 1, 15.00, 0.00, 96000.00);

-- 
-- Dumping data for table productos
--
INSERT INTO productos VALUES
(1, 'Inspiron 15 5000', 'Laptop de 15 pulgadas que es su centro personal de entretenimiento en el hogar para una visualización envolvente, con un borde estrecho y un procesador Intel® de décima generación.', 39, 4, 1, 32000.00, 32000.00, 3),
(2, 'HP Laptop 15-gw0017la', 'Creada para mantenerte productivo y conectado, la HP Laptop 15 combina batería de larga duración y una pantalla de bordes súper delgado, en un diseño con mucho estilo.', 0, 4, 1, 35000.00, 35000.00, 2),
(3, 'MacBook Pro de 13”', 'Con el chip M1, la MacBook Pro de 13 pulgadas alcanza un nuevo nivel de potencia y velocidad. El CPU es hasta 2.8 veces más rápido y los gráficos son hasta 5 veces más veloces. Nuestro Neural Engine más avanzado hasta ahora permite un aprendizaje automático hasta 11 veces más rápido. Y la batería te acompaña todo el día: hasta 20 horas de duración. Es nuestra notebook Pro más conocida, a un nivel mucho más pro.', 15, 4, 1, 40000.00, 45000.00, 5),
(8, 'Laptop Dell Inspiron 15" ', 'Laptop de 15 pulgadas que ofrece un rendimiento con capacidad de respuesta en un diseño elegante con bordes angostos de dos lados, ExpressCharge, y procesadores Intel Core.  Cap. Disco Duro (5400 RPM) GB - 1 TB Memoria RAM Instalada GB - 4 GB Procesador - Intel Core i3 Resolución Pantalla (Pixeles) - 1366 x 768 Pixeles', 56, 4, 1, 10000.00, 10000.00, 3),
(13, 'Laptop HP 250 G7 15" ', 'Laptop HP 250 G7 15" Intel Core i3 Memoria RAM 4GB/ Disco Duro 1TB Negra\nHP-250-G7\nCap. Disco Duro (5400 RPM) GB - 1 TB\nMemoria RAM Instalada GB - 4GB\nProcesador - Intel Core i3 (10ma generación)\nResolución Pantalla (Pixeles) - 1366 x 768 pixeles', 17, 4, 1, 10000.00, 11995.00, 3),
(17, 'Lenovo Chromebook 2-en-1 Laptop convertible', 'Lector de alto rendimiento: el Chromebook C330 está equipado con un procesador MediaTek MTK8173C, Chrome OS, 4 GB LPDDR3, 64 GB eMMC 5.1 y mucho más.\nDiseño elegante y elegante: elegante, elegante y seguro, este pequeño portátil tiene menos de una pulgada de grosor y 2,6 libras. con una pantalla táctil IPS FHD de 11 pulgadas perfecta para la informática diaria y multimedia, en línea o sin conexión.', 49, 3, 1, 36000.00, 42000.00, 4),
(18, 'Laptop Dell Inspiron 14"', 'Laptop 2 en 1 de 14 pulgadas diseñada para acercar su mundo. Cuenta con un borde estrecho de 4 lados y los últimos procesadores Intel® Core™ de 11.ª generación.\n\nCap. Disco Duro Solido (GB) - 256 GB\nMemoria RAM Instalada GB - 8 GB\nProcesador - Intel Core i3\nResolución Pantalla (Pixeles) - 1920 x 1080 pixeles', 24, 8, 1, 20000.00, 23999.00, 3),
(19, 'Laptop Dell Inspiron 156" ', '4gb de ram ,220 ssd', 20, 8, 1, 10000.00, 10000.00, 3),
(20, 'Prueba ', 'buena pc', 122, 6, 1, 12000.00, 15000.00, 1);
...
(8, 'AlanMejia', '12345678', 3, 'alan123@gmail.com', 4, NULL, 1),
(9, 'LuisF', 'luis1234flores', 2, 'lf016158@gmail.com', 2, NULL, 1);
